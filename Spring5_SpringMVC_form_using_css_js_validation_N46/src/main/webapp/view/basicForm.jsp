...
<title>Form</title>
<link href="${pageContext.request.contextPath}/additional/css/style.css" rel="stylesheet">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/additional/js/clientSideValidation.js"></script>
</body>
</html>