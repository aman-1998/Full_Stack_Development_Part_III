...
public class UserRegistrationController {
	...
	private ModelAndView initRegistration(UserRegistrationDTO userRegistrationDTO) {
		...
		//------------ Just for testing AOP --------------------------------
		userService.testing2();
		
		//------------ Just for testing AOP --------------------------------
		userService.testing1(false); //userService.testing1(true);
		
		//------------ Just for testing AOP --------------------------------
		String result1 = userService.testing3(false);
		System.out.println("Returned value of testing3 : " + result1);
		
		//------------ Just for testing AOP --------------------------------
		String result2 = userService.testing3(true);
		System.out.println("Returned value of testing3 : " + result2);
