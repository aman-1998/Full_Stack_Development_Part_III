function validateForm() {
  ...
  if (name == "") {
    ...
    var errorMsg = "Name can not be empty";
  	var imageSrc = "<img src='http://localhost:8080/Spring5_SpringMVC_form_customized_error_message_N47/additional/images/warning.png' width='35px' height='35px' style='vertical-align:middle;'>";
