CREATE TABLE "COUNTRY" (
	...
	"COUNTRY_FULL_NAME" VARCHAR2(128) NOT NULL,
...
CREATE TABLE "ROLE" (
   ...
   "ROLE_DISPLAY_NAME" VARCHAR2(100) NOT NULL,
...
CREATE TABLE "CONSTRAINT_LIST" (
	...
	CONSTRAINT "CONSTRAINT_LIST_PK" PRIMARY KEY ("ID"),
	CONSTRAINT "CONSTRAINT_NAME_UNIQUE" UNIQUE ("CONSTRAINT_NAME")
);

CREATE TABLE "CONSTRAINT_VALUES" (
	"ID" NUMBER(4) NOT NULL,
	"CONSTRAINT_LIST_ID" NUMBER(3) NOT NULL,
	"CONSTRAINT_VALUE" VARCHAR2(100),
	CONSTRAINT "CONSTRAINT_VALUES_PK" PRIMARY KEY ("ID"),
	CONSTRAINT "CONSTRAINT_LIST_ID_FK" FOREIGN KEY ("CONSTRAINT_LIST_ID") REFERENCES "CONSTRAINT_LIST" ("ID")
);

CREATE TABLE "AUTHORIZATION_RULE" (
	"ID" NUMBER(2) NOT NULL,
	"RULE_NAME" VARCHAR2(50) NOT NULL,
	"AUTH_REQUIRED" CHAR(1 BYTE),
	"DESCRIPTION" VARCHAR2(100),
	CONSTRAINT "AUTHORIZATION_RULE_PK" PRIMARY KEY ("ID"),
