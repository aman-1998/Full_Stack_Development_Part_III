...
<ul>
  ...
  <security:authorize access="isAuthenticated()">
  	<li><a class="active" href="${pageContext.request.contextPath}/notice">Notice</a></li>
...
<div style="margin-left:25%;padding:1px 16px;height:700px;">
  ...
  <h3>Notice</h3>
  <ol type="i">
	 <li><a href="#">CBSE class X result 2022</a></li>
	 <li><a href="#">CBSE class XII result 2022</a></li>
	 <li><a href="#">New Timings for Nursery, KG-1 and KG-2 during winters</a></li>
	 <li><a href="#">Pre-board Examination Dates for class 10</a></li>
	 <li><a href="#">Pre-board Examination Dates for class 12</a></li>
  </ol>
