...
<div class="wrapper">
        <div class="logo">
            <img src="${pageContext.request.contextPath}/additional/images/board.png" alt="CBSE">
        </div>
	    ...
	    <div class="message text-center fs-6">
		    ...
		    <c:if test="${reservedUsername != null}">
				<p style="color: #ff0000"><i><spring:message code="label.reserved.username"/></i></p>
		    </c:if>
	    </div>
    </div>
